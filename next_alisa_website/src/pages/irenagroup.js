...
import Irenagroup from "@/components/Portfolio/Projects/Irenagroup";
import Irenagroup_mobil from "@/components/Portfolio/Projects/Irenagroup_Mobil";
import {GLOBAL_SITE_TYPE} from "@/config";

export default function LandIrina() {
  return (
    <>
      <Head>
        <title>дизайн группы ВК</title>
      ...
      <main className={`${styles.main} ${inter.className}`}>
        {GLOBAL_SITE_TYPE=='mobile' ? <Irenagroup_mobil/> : <Irenagroup/>}
      </main>
    </>
  )
}
