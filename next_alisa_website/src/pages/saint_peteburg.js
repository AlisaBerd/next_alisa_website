...
import Saint_mobil from "@/components/Portfolio/Projects/Saint_mobil";
import Saint from "@/components/Portfolio/Projects/Saint";
  ...
  return (
    <>
      ...
      <main className={`${styles.main} ${inter.className}`}>
        {GLOBAL_SITE_TYPE=='mobile' ? <Saint_mobil/> : <Saint/>}
      </main>
    </>
  )
}
